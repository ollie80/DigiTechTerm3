...
Refused to load the image 'blob:file:///aff6a795-d1d1-4f4a-af15-6fa25181df61' because it violates the following Content Security Policy directive: "img-src 'self' data:".
...
- 💡 OptimizRefused to load the image 'blob:file:///aff6a795-d1d1-4f4a-af15-6fa25181df61' because it violates the following Content Security Policy directive: "img-src 'self' data:".e asset handling
- 🚀 Fast HMR for renderer processes
- 🔥 Hot reloading for main process and preload scripts
- 🔌 Easy to debug
- 🔒 Compile to v8 bytecode to protect source code

## Getting SRefused to load the image 'blob:file:///aff6a795-d1d1-4f4a-af15-6fa25181df61' because it violates the following Content Security Policy directive: "img-src 'self' data:".tarted
